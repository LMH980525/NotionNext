...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个星火爱好者, Hi，我是一个星火爱好者,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '我的六月雪', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的星火菜鸡🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xhdl.link/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '我的六月雪, 博客', // 网站关键词 英文逗号隔开
  ...
  //   ********挂件组件相关********
  // Chatbase
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || www.chatbase.co/chatbot-iframe/GmJi1tTalXDFLL8xqIZai, // 是否显示chatbase机器人 https://www.chatbase.co/
  // 悬浮挂件
